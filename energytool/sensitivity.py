...
class SAnalysis:
    def __init__(self, building, sensitivity_method, parameters):
    ...
    def available_indicators(self):
        ...
        available = list(self.simulation_list[0].building.building_results.columns)
        ...
        if custom_indicator is None:
            ...
            y_array = np.array(
                [
                    ...
                    if indicator != "Total"
                    else aggregation_method(simu.building.building_results.sum(axis=1))
